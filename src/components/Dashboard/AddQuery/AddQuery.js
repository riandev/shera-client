  ...
  return (
    <div className="w-50">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        />
        <label htmlFor="channel"> <b> Channel Name:</b></label>
        <input
          className="form-control"
          defaultValue=""
          {...register("channel")}
        ...
        <Form.Row>
          <Form.Group as={Col} controlId="formGridZip">
            <Form.Label> <b>Facebook Link:</b></Form.Label>
            <Form.Control {...register("fbid")} />
          </Form.Group>
          <Form.Group as={Col} controlId="formGridCity">
            <Form.Label> <b>Query Purpose:</b></Form.Label>
        ...
        <Form.Row>
          ...
          <Form.Group as={Col} controlId="formGridCity">
            <Form.Label> <b>Product Query</b></Form.Label>
            <Form.Control {...register("productQuery")} />
          </Form.Group>

          <Form.Group as={Col} controlId="formGridState">
            <Form.Label> <b>Sell Status</b></Form.Label>
            <Form.Control
              {...register("sellStatus")}
              as="select"
              defaultValue="Choose..."
        ...
        <label htmlFor="remarks"> <b>Remakrs:</b></label>
        <input
          className="form-control"
          defaultValue=""
          {...register("remarks")}
